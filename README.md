...
[**Fibonacci Sequence**](https://github.com/chaitan94/Projects/blob/master/Numbers/fibonacci.c) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

**Prime Factorization** - Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/chaitan94/Projects/blob/master/Numbers/nextPrime.c) - Have the program find prime numbers until the user chooses to stop asking for the next one.
...
[**In-console loading bar**](https://github.com/chaitan94/Projects/blob/master/Text/loadingBar.c) - Create a bar inside console whose length changes according to percentage value, and progressively incereases from 0% to 100%.
